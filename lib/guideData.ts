...
export const guideGroups: GuideGroup[] = [
  ...
  },
  {
    ...
    labelPt: "Mapa Vegano",
    labelEs: "Mapa Vegano",
    descEn: "44 vegan and vegan-friendly restaurants, bakeries, and cafes across Seoul, all on one map.",
    descKo: "서울의 비건 식당, 베이커리, 카페 44곳을 한 지도에 모았어요.",
    descJa: "ソウルのヴィーガン対応レストラン、ベーカリー、カフェ44か所を一つの地図に。",
    descZhCN: "一张地图收录首尔44家素食餐厅、面包店和咖啡馆。",
    descZhTW: "一張地圖收錄首爾44家素食餐廳、麵包店和咖啡館。",
    descPt: "44 restaurantes, padarias e cafés veganos em Seul, tudo em um só mapa.",
    descEs: "44 restaurantes, panaderías y cafés veganos en Seúl, todo en un solo mapa.",
    items: {
      en: ["Interactive Map", "44 Vegan Places", "Neighborhood Picks"],
      ko: ["인터랙티브 지도", "비건 스팟 44곳", "동네별 추천"],
      ja: ["インタラクティブマップ", "ヴィーガンスポット44選", "エリア別おすすめ"],
      zhCN: ["互动地图", "44家素食好店", "街区推荐"],
      zhTW: ["互動地圖", "44家素食好店", "街區推薦"],
      pt: ["Mapa Interativo", "44 Lugares Veganos", "Dicas por Bairro"],
      es: ["Mapa Interactivo", "44 Lugares Veganos", "Recomendaciones por Barrio"],
    },
    bg: "bg-[#fafaf8]",
    labelColor: "text-[#c9a800]",
    headingColor: "text-zinc-950",
