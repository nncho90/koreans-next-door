...
export const alt = "Working in Korea Guide for Foreigners — Koreans Next Door";
      ...
      <div style={{ width: "100%", height: "100%", display: "flex", background: "#111111", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", padding: "80px 100px", gap: 0 }}>
          <div style={{ display: "flex", alignItems: "center", background: "#ffd966", borderRadius: 100, padding: "8px 20px", width: "fit-content", marginBottom: 36 }}>
            <span style={{ fontSize: 16, color: "#1a1a1a", fontWeight: 700, letterSpacing: 2 }}>WORKING IN KOREA</span>
          </div>
          <div style={{ fontSize: 86, fontWeight: 800, color: "#ffffff", lineHeight: 1.0, letterSpacing: -3, marginBottom: 4 }}>Know your</div>
          <div style={{ fontSize: 86, fontWeight: 800, color: "#ffd966", lineHeight: 1.0, letterSpacing: -3, marginBottom: 36 }}>rights at work</div>
          <div style={{ fontSize: 26, color: "rgba(255,255,255,0.50)", fontWeight: 400, maxWidth: 700 }}>Contracts, labor rights, workplace culture, and where to find jobs in Korea.</div>
