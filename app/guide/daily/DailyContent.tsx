...
const STRINGS: Record<Locale, {
  ...
  sub: string;
  updated: string;
  nav: { recycling: string; apps: string; phone: string; delivery: string; license: string };
}> = {
  en: {
    label: "Daily Life",
    heading: "Living in\nKorea",
    ...
    nav: { recycling: "Recycling", apps: "Essential Apps", phone: "Phone Plans", delivery: "Delivery", license: "Driver's License" },
  },
  ko: {
    label: "일상 생활",
    heading: "한국에서\n사는 법",
    ...
    nav: { recycling: "분리수거", apps: "필수 앱", phone: "요금제", delivery: "배달", license: "운전면허" },
  },
  ja: {
    label: "日常生活",
    heading: "韓国での\n暮らし方",
    ...
    nav: { recycling: "ゴミ分別", apps: "必須アプリ", phone: "携帯プラン", delivery: "デリバリー", license: "運転免許" },
  },
  "zh-CN": {
    label: "日常生活",
    heading: "在韩国\n的生活",
    ...
    nav: { recycling: "垃圾分类", apps: "必备App", phone: "手机套餐", delivery: "外卖", license: "驾驶证" },
  },
  "zh-TW": {
    label: "日常生活",
    heading: "在韓國\n的生活",
    ...
    nav: { recycling: "垃圾分類", apps: "必備App", phone: "手機方案", delivery: "外送", license: "駕照" },
  },
  pt: {
    ...
    nav: { recycling: "Reciclagem", apps: "Apps Essenciais", phone: "Planos de Celular", delivery: "Delivery", license: "Carteira de Motorista" },
  },
  es: {
    label: "Vida Diaria",
    heading: "Vivir\nen Corea",
    ...
    nav: { recycling: "Reciclaje", apps: "Apps Esenciales", phone: "Planes de Celular", delivery: "Delivery", license: "Licencia de Conducir" },
  },
};
