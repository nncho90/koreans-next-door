...
export const proofMedia: ProofItem[] = [
  ...
  { kind: "photo", src: "/photos/knd-21.jpeg", alt: "A KND member working through a Korean workbook at a language exchange table" },
  ...
  { kind: "photo", src: "/photos/knd-22.jpeg", alt: "KND neighbors gathered at night with the Seoul skyline lit up behind them" },
